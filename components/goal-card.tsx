...
export function GoalCard({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl bg-card p-4 transition-shadow hover:shadow-lg hover:shadow-primary/5">
      <div className="flex items-start justify-between">
        ...
        <span className="shrink-0 rounded-full border border-reward px-3 py-1 text-sm font-medium text-reward">
          ${reward} Reward
        </span>
      </div>
